...
public class Images {
    ...
    public static ImageIcon get_pokemon_icon(int id){
        ...
        return new ImageIcon("images\\sprites\\" + id + ".png");
    }
    ...
    public static ImageIcon get_type_icon(String type){
        ...
        return new ImageIcon("images\\types\\" + Convert.capitalize_first_letter(type) + "IC_XY.png");
    }
    ...
    public static ImageIcon get_check_icon(String check){
        return new ImageIcon("images\\check\\" + Convert.capitalize_first_letter(check) + ".png");
    }
